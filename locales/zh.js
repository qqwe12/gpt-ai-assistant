const zh = {
  ...
  __COMMAND_ANALYZE_GANTT_LABEL: '甘特圖規劃',
  __COMMAND_ANALYZE_GANTT_TEXT: '甘特圖規劃',
  __COMMAND_ANALYZE_GANTT_PROMPT: '請根據以下需求，規劃動態甘特圖系統，包含資料模型、流程、預計/實際進度計算、日期調整邏輯，並提供建議的資料欄位與技術架構。',
