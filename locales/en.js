const en = {
  ...
  __COMMAND_ANALYZE_GANTT_LABEL: 'Gantt planning',
  __COMMAND_ANALYZE_GANTT_TEXT: 'Gantt planning',
  __COMMAND_ANALYZE_GANTT_PROMPT: 'Please propose a dynamic Gantt chart system based on the following requirements, including data models, workflows, planned vs. actual progress calculations, date adjustment logic, and suggested fields/architecture.',
