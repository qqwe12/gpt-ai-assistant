const ja = {
  ...
  __COMMAND_ANALYZE_GANTT_LABEL: 'ガントチャート設計',
  __COMMAND_ANALYZE_GANTT_TEXT: 'ガントチャート設計',
  __COMMAND_ANALYZE_GANTT_PROMPT: '以下の要件に基づき、動的ガントチャートシステムを設計し、データモデル、ワークフロー、予定/実績進捗計算、日付調整ロジック、推奨フィールドとアーキテクチャを示してください。',
